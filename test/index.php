    ...
    <div id="Nav">
        <div id="NavbarContainer">
            <div class="row">
                ...
                <div id="NavInfo">
                    <ul id="NavMenu">
                        <li class="NavItem"><a class="NavLinks" href="#"><span id='Bg-coins'>100000<span class="yellow-coins">+</span></span></a></li>
            ...
            <div class="Wrapper">
                <div class="row">
                    ...
                    <div class="Bets" id='betMenu'>
                        ...
                        <div class="InfoBets">
                            <small>Łączna stawka: <span class="text-bold">0</span></small>
                            <p>Potencjalna wygrana: <span class="text-bold text-blue">0</span></p>
