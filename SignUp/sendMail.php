...
function sendMail($email, $otp){
        ...
        <tbody>          
            <tr>
                <td><h2>Weryfikacja konta!</h2></td>
            </tr>
            <tr>
                <td style="font-size:14px"><p>Szanowny graczu, <br> Bardzo dziękujemy za zarejestrowanie swojego konta na naszej platformie. Poniżej przesyłamy kod do weryfikacji. <br> Po uzupełnieniu wymaganych pól, twoje konto zostanie zweryfikowane i będziesz mógł swobodnie czerpać przyjemność z gry na naszym serwisie. <br> W przypadku jakichkolwiek pytań lub wątpliwości, jesteśmy do usług. </p></td>
            </tr>
            <tr>
                <td><h3 style="margin-bottom:50px"><b>'.$otp.'</b></h3></td>
            </tr>
        </tbody>
        <tfoot>
          <tr>
